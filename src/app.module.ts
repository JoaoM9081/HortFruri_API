...
@Module({
  imports: [
    ...
    UsuarioModule, ConsumidorModule, EntregadorModule, LojaModule, CategoriaModule, ProdutoModule, EnderecoModule, EstoqueModule, PedidoModule, ItemPedidoModule, PagamentoModule],
